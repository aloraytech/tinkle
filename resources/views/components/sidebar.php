...
<!--        SIDEBAR-->
<div class="d-flex flex-column flex-shrink-0 bg-dark text-white" style="width: 4.5rem;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        ...
        <li>
            <a href="#" class="nav-link py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard" aria-describedby="tooltip370644">
    ...
    <div class="dropdown border-top">
        <a href="#" class="d-flex align-items-center justify-content-center p-3 link-dark text-decoration-none dropdown-toggle" id="dropdownUser3" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="assets/mdo.png" alt="mdo" width="24" height="24" class="rounded-circle">
        </a>
...
<!--        ./SIDEBAR ./-->
<!--    Divider Between Sidebar And Page Area-->
